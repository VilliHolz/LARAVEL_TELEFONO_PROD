    ...
    <div class="row shadow-sm">
        ...
        <div class="col-md-5">
            ...
            @if (!empty($cart))
                ...
                <button class="btn btn-outline-primary mb-2" wire:click="openModalProcesar()">Guardar
                    Venta
                </button>
            @else
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 mb-2">
                            <label for="payment_method_id">Forma Pago</label>
                            <select id="payment_method_id" class="form-control form-control-lg"
                                wire:model="payment_method_id" {{ $method === 'CREDITO' ? 'disabled' : '' }}>
                        ...
                        <div class="form-group col-md-6 mb-2">
                            <label for="method">Método <span class="text-danger">*</span></label>
                            <select id="method" class="form-control form-control-lg" wire:model.live="method">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" wire:click="saveSale()">Guardar</button>
                </div>
            </div>
        </div>
    </div>
