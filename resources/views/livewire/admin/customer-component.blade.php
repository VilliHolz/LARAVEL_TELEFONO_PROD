    ...
    <div class="row shadow-sm">
        <div class="col-lg-12">
            ...
            @can('reportes clientes')
                <a href="{{ route('exportClients', 'client') }}" class="btn btn-outline-success btn-sm">
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content bg-gray">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $contact_id ? 'Editar Cliente' : 'Crear Cliente' }}</h5>
            ...
            Livewire.on('show-delete-confirmation', id => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatchTo('admin.customer-component', 'delete', {
                            valor: id
                        });
                    }
                })
